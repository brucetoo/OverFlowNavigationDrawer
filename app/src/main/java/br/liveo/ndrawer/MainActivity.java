...
public class MainActivity extends NavigationLiveo implements NavigationLiveoListener {
    ...
    public void onUserInformation() {
        ...
        this.mUserName.setText("Bruce Too");
        this.mUserEmail.setText("brucetoo14@gmail.com");
        this.mUserPhoto.setImageResource(R.drawable.ic_icon);
    ...
    public void onInt(Bundle savedInstanceState) {
        ...
        //这里表示在位置等于4的地方加上副标题，位置等于4的地方必须在之前就已经有副标题 mListNameItem.add(4, getString(R.string.more_markers));
        List<Integer> mListHeaderItem = new ArrayList<>();
        mListHeaderItem.add(4);

        //{optional} - Among the names there is any item counter, you must indicate it (position) and the value here
        //每个Item中可能会统计数量，这表示在某个位置设置数量>100，用99+
